                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="3"
                                          class="mt-1 block w-full rounded-lg border-slate-300 text-sm
                                                 focus:border-blue-500 focus:ring-blue-500">{{ old('description', $application->description) }}</textarea>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <x-text-input id="url" name="url" type="url" class="mt-1 block w-full"
                                              value="{{ old('url', $application->url) }}" required />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                ...
                                <select id="category_id" name="category_id"
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                                @selected(old('category_id', $application->category_id) == $category->id)>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="owner" name="owner" type="text" class="mt-1 block w-full"
                                              value="{{ old('owner', $application->owner) }}" />
                            ...
                            <div>
                                ...
                                <select id="environment" name="environment"
                                    ...
                                    @foreach (['Production', 'Staging', 'Development'] as $env)
                                        <option value="{{ $env }}" @selected(old('environment', $application->environment) === $env)>
                                            {{ $env }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <select id="status" name="status"
                                    ...
                                    @foreach (['active' => 'Active', 'inactive' => 'Inactive', 'maintenance' => 'Maintenance'] as $value => $label)
                                        <option value="{{ $value }}" @selected(old('status', $application->status) === $value)>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="display_order" name="display_order" type="number" class="mt-1 block w-full"
                                              value="{{ old('display_order', $application->display_order) }}" min="0" />
